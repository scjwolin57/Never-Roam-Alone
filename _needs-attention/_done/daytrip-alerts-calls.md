# Day-trip safety alerts: calls for Jeff (started 2026-09-23)

The alert pass (`RESUME_daytrip-alerts.md`) shows an alert only where a government's own words clearly
cover the place. Where the wording is too vague to say, the trip is left **without** an alert and listed here.
Your answer settles it; it is then recorded in `_guidebuild/daytrips/alerts/overrides.json`.

## 1. India: US "parts of Central and East India" (Maoist/Naxalite areas)
...
## 2. Egypt: US "Northern and Middle Sinai"
