...
(function(){
  ...
  .nra-ml .ml-kicker{font-family:'Work Sans',monospace;color:#5c6933;font-weight:600;text-transform:uppercase;letter-spacing:.2em;font-size:.66rem;margin:0 0 10px}
  ...
  .nra-ml button{border:none;cursor:pointer;background:#b5492c;color:#fff;font-weight:600;font-size:.8rem;font-family:'Work Sans',monospace;text-transform:uppercase;letter-spacing:.08em;padding:14px 26px;border-radius:0;transition:background .2s}
