...
(function(){
  ...
  .nra-ml .ml-kicker{font-family:'IBM Plex Mono',monospace;color:#3f5138;font-weight:600;text-transform:uppercase;letter-spacing:.2em;font-size:.66rem;margin:0 0 10px}
  ...
  .nra-ml button{border:none;cursor:pointer;background:#a8482a;color:#fff;font-weight:600;font-size:.8rem;font-family:'IBM Plex Mono',monospace;text-transform:uppercase;letter-spacing:.08em;padding:14px 26px;border-radius:0;transition:background .2s}
